...
namespace Crucible
{
	...
	public:
		...
		/*/
		CombatValueIDMap _inputMap{};

		CachedCombatValueContainer evade{ CombatValue::kEvade, _inputMap };
		CachedCombatValueContainer resist{ CombatValue::kResist, _inputMap };
		SimpleCombatValueContainer stagger{ CombatValue::kStagger, _inputMap };
		SimpleCombatValueContainer precision{ CombatValue::kPrecision, _inputMap };
		//*/
		...
		std::list<CombatValueEffect*>* GetPortList() override { return &activeEffects; }
